  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
        ...
        itemBuilder: (context , index){
          ...
          return ListTile(
              onTap: (){
              Navigator.of(context).push(MaterialPageRoute(builder: (context) => ViewMail(image:binlist[index].image, name:binlist[index].name, caption: binlist[index].caption , body:binlist[index].body, id:binlist[index].id, timestamp:binlist[index].timestamp, isRead:binlist[index].isRead)));
            },
